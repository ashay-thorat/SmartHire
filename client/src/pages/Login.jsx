    ...
    <div className="min-h-[calc(100vh-4rem)] bg-slate-50 flex items-center justify-center px-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md my-8">
        <div className="text-center mb-8">
          ...
          <h2 className="font-heading font-extrabold text-2xl sm:text-3xl text-accent">Welcome Back</h2>
          <p className="text-text-muted text-sm mt-2">Sign in to manage your career or recruitment pipelines</p>
        </div>
